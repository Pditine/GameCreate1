...
namespace Pditine.Component
{
    ...
    /// UGUI描边
    /// </summary>
    public class UGUIOutline : BaseMeshEffect
    {
        ...
        {
            for (int i = 0, count = _vertexList.Count - 3; i <= count; i += 3)
            {
                var v1 = _vertexList[i];
                var v2 = _vertexList[i + 1];
                var v3 = _vertexList[i + 2];
                // 计算原顶点坐标中心点
                //
